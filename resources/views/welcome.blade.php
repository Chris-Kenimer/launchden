...
<body>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    <p class="category"> Available ICO Funds</p>
                                    <h3 class="title">$28,000
                                        <small>USD</small>
                                    </h3>
                                </div>
                                <div class="card-footer">
                                    <div class="stats">
                                        ...
                                        <a href="#pablo">Allocate More Funds...</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    <p class="category">ICOs Opening this week</p>
                                    <h3 class="title">3</h3>
                                </div>
                                <div class="card-footer">
                                    <div class="stats">
                                        <i class="material-icons">local_offer</i> Placeholder
                                    </div>
                                </div>
                            </div>
                        </div>
  ...
  <path fill="#000000" d="M4.5,5H8V2H10V5H11.5V2H13.5V5C19,5 19,11 16,11.25C20,11 21,19 13.5,19V22H11.5V19H10V22H8V19H4.5L5,17H6A1,1 0 0,0 7,16V8A1,1 0 0,0 6,7H4.5V5M10,7V11C10,11 14.5,11.25 14.5,9C14.5,6.75 10,7 10,7M10,12.5V17C10,17 15.5,17 15.5,14.75C15.5,12.5 10,12.5 10,12.5Z" />
                                ...
                                <div class="card-content">
                                    <p class="category">BTC Value</p>
                                    <h3 class="title">$11,205</h3>
                                </div>
                                <div class="card-footer">
                                    <div class="stats">
